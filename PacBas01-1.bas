...
1000 REM X = RND(-TI) : rem RND seed?
...
1022 DIM pa(3):DIM g1a(3):DIM g2a(3):x=0:y=1:l=2
1025 pa(x)=30:pa(y)=17*yoff+1024
1030 g1a(x)=3:g1a(y)=5*yoff+1024:g1a(l)=3 
1040 g2a(x)=30:g2a(y)=17*yoff+1024:g2a(l)=1
1050 xtg=0:ytg=0:ltg=0
1175 rem clear screen,draw map, draw ghosts
1180 print chr$(147)
1190 gosub 1800
1200 poke g1a(y)+g1a(x),65
1205 poke g2a(y)+g2a(x),65
...
1290 xtg=g1a(x):ytg=g1a(y):ltg=g1a(l)
1330 gosub 1515
1340 g1a(x)=xtg:g1a(y)=ytg:g1a(l)=ltg
1380 rem ******* Move Ghost 2 **********
1390 xtg=g2a(x):ytg=g2a(y):ltg=g2a(l)
1400 gosub 1515
1410 g2a(x)=xtg:g2a(y)=ytg:g2a(l)=ltg
1480 return
1490 rem -----------------------------------------------------------------------
