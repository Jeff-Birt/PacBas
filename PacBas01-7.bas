...
460 rem -------------------------------
470 rem ****** Move player ************
480 d=.:j=peek(56320):poke p(y)+p(x),32
570 rem ** can move north
580 if (j and 1) then goto 600
585 if peek(p(y)-yo+p(x))<>wa then p(y)=p(y)-yo
588 d=1:goto 650
590 rem ** can move south
600 if (j and 2) then goto 620
605 if peek(p(y)+yo+p(x))<>wa then p(y)=p(y)+yo
608 d=2:goto 650
610 rem ** can move east
620 if (j and 8) then goto 640
625 if peek(p(y)+p(x)+1)<>wa then p(x)=p(x)+1
626 d=3:goto 650
630 rem ** can move west
640 if (j and 4) then goto 650
645 if peek(p(y)+p(x)-1)<>wa then p(x)=p(x)-1
646 d=4:goto 650
650 poke p(y)+p(x),pc
660 return
670 rem -------------------------------
